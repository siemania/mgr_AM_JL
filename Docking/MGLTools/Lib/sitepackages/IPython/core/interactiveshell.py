...
class InteractiveShell(SingletonConfigurable):
    ...
    def init_virtualenv(self):
        ...
        virtualenv was built, and it ignores the --no-sitepackages option. A
        ...
        if sys.platform == "win32":
            virtual_env = os.path.join(os.environ['VIRTUAL_ENV'], 'Lib', 'sitepackages')
        else:
            virtual_env = os.path.join(os.environ['VIRTUAL_ENV'], 'lib',
                       'python%d.%d' % sys.version_info[:2], 'sitepackages')
