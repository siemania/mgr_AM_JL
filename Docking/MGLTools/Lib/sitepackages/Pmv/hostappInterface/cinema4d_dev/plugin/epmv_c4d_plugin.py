...
#    sys.path.insert(0,MGL_ROOT+'/lib/python2.5/sitepackages')
#    sys.path.insert(0,MGL_ROOT+'/lib/python2.5/sitepackages/PIL')
...
#sys.path.append('/Library/MGLTools/REL/python2.6/lib/python2.6/sitepackages')
#sys.path.append('/Library/Python/2.6/sitepackages/')
#sys.path.append('/Library/Python/2.6/sitepackages/numpy-1.3.0-py2.6-macosx-10.6-universal.egg/')
#sys.path.append('/Library/Python/2.6/sitepackages/PIL/')
