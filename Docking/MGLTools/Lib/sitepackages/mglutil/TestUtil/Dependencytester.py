...
########################################################################
 ...
 def rundependencychecker(self,pack,v=True,V=False,loc=None):    
  ...
  for i in sys.path:
        s =i.split('/')    
        if s[-1]=="MGLToolsPckgs" or s[-1]== 'sitepackages':
        #if s[-1]=='FDepPackages' or s[-1]=='RDepPackages' or s[-1]=='FSharedPackages' or s[-1]=='RSharedPackages' or s[-1]== 'sitepackages':
            pn.append(i)
            ...
            if fi[-3:]=='.py':
                ...
                if len(candidates)>0:
                    ...
                    for candidate_num in candidates:
                        ...
                        path =string.split(p,'sitepackages')[-1]
                        implist =[]
                        fromlist=[] 
                        y =string.split(imp)
                        ...
                        if y[0]=='import':
                            ...
                            for im in implist:                                
                                ...
                                try:        
                                    ...
                                    #sitepackages and append to result
