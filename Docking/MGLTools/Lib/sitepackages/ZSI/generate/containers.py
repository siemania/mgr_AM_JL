...
class ServiceDocumentLiteralMessageContainer(ServiceContainerBase, 
    ...
    def _setContent(self):
        ...
        #  File "/usr/local/python/lib/python2.4/sitepackages/ZSI/generate/containers.py", line 625, in _setContent
        #    kw['message'],kw['prefix'],kw['typecode'] = \
        #  File "/usr/local/python/lib/python2.4/sitepackages/ZSI/generate/containers.py", line 128, in getNSAlias
        #    raise ContainerError, 'no self.ns attr defined in %s' % self.__class__
