...
def modify_gpf(input_gpf, output_gpf, map_dir="map_grid_files", receptor_dir="pdbqt_files", quiet=False):
    """Modyfikuje i zapisuje w nowej lokalizacji plik .gpf lub .dpf uwzględniając inne foldery dla
    map energetycznych oraz receptora"""
...
def modify_gdpf_overwrite(input_gpf, map_dir="map_grid_files", receptor_dir="pdbqt_files", quiet=False):
    """Modyfikuje i nadpisuje plik .gpf lub .dpf uwzględniając inne foldery dla map energetycznych oraz receptora"""
