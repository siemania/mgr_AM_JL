...
Example:: 
    ...
    sys.path.insert(0,"/Library/Python/2.6/sitepackages/")
    sys.path.insert("/Library/Python/2.6/sitepackages/PIL")
    sys.path.append(MGL_ROOT+'/MGLToolsPckgs')
    sys.path.append(MGL_ROOT+'/lib/python2.6/sitepackages/') #Pmw
    ...
    def getSurfaceVFN(self,geometry):
        ...
        if geometry:
            if not hasattr(geometry,'asIndexedPolygons'):
                ...
                fn = geom.getFNormals()
                f = geom.getFaces()
            return numpy.array(v), f,numpy.array(vn),fn
